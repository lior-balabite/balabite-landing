      ...
      <div className="max-w-[72rem] mx-auto">
        ...
        >
          ...
          <p className="text-lg text-primary-400 max-w-[36rem] mx-auto">
            Menu. Kitchen. Staff. Finances. Marketing. Guests. Phone.
            And somehow you&apos;re also supposed to cook.
          </p>
        </motion.div>
            ...
            {!collapsed ? (
              ...
              >
                <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-black/40">
                  {/* Static image (video overlay will go here later) */}
                  <Image
                    src="/illustrations/scenes/hat-stack.png"
                    alt="Nine hats stacked precariously — a restaurant owner doing everything alone"
                    width={800}
                    height={1200}
